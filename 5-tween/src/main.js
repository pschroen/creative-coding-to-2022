...
import { ticker, tween } from 'alien.js';
...
class DotScreenMaterial extends RawShaderMaterial {
    constructor() {
        super({
            uniforms: {
...
class RGBShiftMaterial extends RawShaderMaterial {
    constructor() {
        super({
...
class RenderManager {
    ...
    static animateIn = () => {
        ...
        tween(this.rgbMaterial.uniforms.amount, { value: 0.5 }, 500, 'easeOutQuad');
    };
}
